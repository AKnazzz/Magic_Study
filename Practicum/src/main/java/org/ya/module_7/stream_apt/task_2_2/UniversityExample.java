...
public class UniversityExample {
    ...
    public static void main(String[] args) {
        ...
        List<Student> graduatedStudents = students.stream()
                .filter((student) -> examPassedNames.contains(
                        student.surname + " " + student.name))  // проверка, что студент успешно сдал экзамен
                .peek((student) -> student.groupName = groupNames.get(
                        student.entranceYear)) // заполнение названия группы студента
