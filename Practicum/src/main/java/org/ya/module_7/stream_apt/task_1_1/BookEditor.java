package org.ya.module_7.stream_apt.task_1_1;
...
public class BookEditor {
    ...
    public static void main(String[] args) {
        ...
        bookEditor.setHeaderDecorator(a -> a.toUpperCase() + "\n");
        bookEditor.addLineProcessor(a -> a.substring(0, 1).toUpperCase() + a.substring(1));
