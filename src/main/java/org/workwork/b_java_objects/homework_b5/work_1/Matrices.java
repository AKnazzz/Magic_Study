package org.workwork.b_java_objects.homework_b5.work_1;
...
public class Matrices {
    ...
    public static class Vector {
        ...
        public Vector dotProduct(Vector other) {
            ...
            for (int i = 0; i < this.items.length; i++){
                this.items[i] = other.items[i] + this.items[i];
            }
            return this;
        }
        ...
        public Vector scalarMultiply(int scalar) {
            for (int i = 0; i < this.items.length; i++) {
                this.items[i] = this.items[i] * scalar;
            }
            return this;
        }
    ...
    public static class Matrix {
        ...
        public Matrix transpose() {
            ...
            for (int row = 0; row < this.nRows; row++) {
                for (int col = 0; col < this.nCols; col++) {
                    result.rows[col][row] = this.rows[row][col];
                }
            }
            return result;
        }
        ...
        public int determinant() {
            ...
            for (int i = 0; i < this.nRows; i++) {
                result += this.rows[i][i] * this.determinant(this.rows);
            }
            return result;
        }
    ...
    public static void main(String[] args) {
        ...
        Vector dotProduct = vectorA.dotProduct(vectorB);
