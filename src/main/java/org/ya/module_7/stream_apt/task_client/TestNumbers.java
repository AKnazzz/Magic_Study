...
public class TestNumbers {
    public static void main(String[] args) {
        ...
        String s = "Минобороны по    поручению деда проведет учения, в ходе которых будет отработано применение    тактического ядерного оружия. Это обещают сделать «в ответ на провокационные заявления и угрозы со стороны Запада».";
