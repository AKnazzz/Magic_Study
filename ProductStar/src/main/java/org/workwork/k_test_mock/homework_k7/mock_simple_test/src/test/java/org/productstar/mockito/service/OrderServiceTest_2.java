...
public class OrderServiceTest_2 {
    ...
    public void init() {
        ...
        orderService = spy(
                new OrderService(customerServiceSpy, warehouseServiceSpy, orderRepositorySpy, productRepositorySpy));
    }
    ...
    public void addProduct_test_existProductNotEnough() throws ProductNotFoundException {
        ...
        assertThrows(ProductNotFoundException.class,
                () -> orderService.addProduct(ivanOrder, "someProduct", 100, false));
    }
